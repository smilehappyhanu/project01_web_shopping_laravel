            ...
            <div class="col-md-6">
                <form action="" method = "POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="textbox" class="form-control" name="user_name" value="{{ $user->name }}" placeholder="Enter user name">                        
                    </div>
                    <div class="form-group">
                        <label>User email</label>
                        <input type="textbox" class="form-control" name="user_email" value="{{ $user->email }}" placeholder="Enter user email">                        
                    </div>
                    <div class="form-group">
